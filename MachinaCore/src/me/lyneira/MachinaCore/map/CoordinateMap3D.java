 ...
 * integer coordinates. The underlying HashMap implementation is GNU Trove's
 * TObjectHash.
 * 
 * @author Lyneira
 * 
 * @param <V> The values for which to create a map.
 */
public class CoordinateMap3D<V> extends THashMap<BlockVector, V> {
    ...
    /**
     * Creates a new <code>CoordinateMap3D</code> instance with a prime
